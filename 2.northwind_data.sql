...
---Populate data into tables using northwind sample database.
---Adapted from https://raw.githubusercontent.com/YugaByte/yugabyte-db/master/sample/northwind_data.sql
--
...
--
TRUNCATE IF EXISTS TERRITORIES;
...
--
TRUNCATE IF EXISTS EMPLOYEE_TERRITORIES;
...
--SELECT COUNT(*) FROM EMPLOYEE_TERRITORIES;
--49

--
-- Data for Name: suppliers; Type: TABLE DATA; Schema: public; Owner: -
--
TRUNCATE IF EXISTS SUPPLIERS;
...
--
TRUNCATE IF EXISTS ORDER_DETAILS; 
